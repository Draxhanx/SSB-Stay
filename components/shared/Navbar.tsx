...
const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full z-50 bg-white/80 dark:bg-gray-950/80 backdrop-blur-md border-b dark:border-gray-800 transition-colors duration-300">
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden bg-white dark:bg-gray-950 border-b dark:border-gray-800 absolute w-full shadow-lg transition-colors duration-300">
